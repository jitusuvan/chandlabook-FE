...
const EventsList = () => {
  ...
  const handleEdit = async (event: Event) => {
    const { value: formValues } = await Swal.fire({
      ...
      didOpen: () => {
        const eventTypeSelect = document.getElementById(
          "swal-input3",
        ) as HTMLSelectElement;
        const brideGroomDiv = document.getElementById("bride-groom-div");
        eventTypeSelect.addEventListener("change", () => {
          if (brideGroomDiv) {
            brideGroomDiv.style.display =
              eventTypeSelect.value === "marriage" ? "block" : "none";
          }
        });
      },
      preConfirm: () => {
        ...
        const event_type = (
          document.getElementById("swal-input3") as HTMLSelectElement
        ).value;
        const bride_groom_name = (
            ...
            >
              <div className="card-body p-3">
                <div className="d-flex justify-content-between align-items-start mb-2">
                  ...
                  <div className="d-flex align-items-center">
                    <span className="me-1">
                      {getSelectTypeBadge(event.select_type)}
                    </span>
